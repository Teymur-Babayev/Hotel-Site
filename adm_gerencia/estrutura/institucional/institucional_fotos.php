<?php 
	...
	$palavra      = "Fotos Institucionais"; //modificar somente essa linha
	$tabela       = "tb_institucional_fotos"; //modificar somente essa linha
	$tabela2      = "tb_institucional"; //modificar somente essa linha
	$file         = "institucional_fotos";
...
?>
	...
	<div class="br-mainpanel" id="cadastra">
        ...
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30 mg-b-20-force">
            ...
            <h4 class="tx-gray-800 mg-b-0 tx-20 tx-bold">
            	<i class="fa fa-list tx-yellow mg-r-10 mg-l-10"></i> <?php echo $dados2['nome'];?> 
			...
			?>
            <h4 class="tx-gray-800 mg-b-0 tx-20 tx-bold">
            	<i class="fa fa-list tx-yellow mg-r-10 mg-l-10"></i> Selecione 
                <span class="tx-yellow tx-13 mg-l-5">(Fotos do Registro)</span>
            </h4>
            <?php
				}
    ...
    <div class="br-mainpanel">
		...
		<div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30 mg-b-20-force">
            <h4 class="tx-gray-800 mg-b-0 tx-20 tx-bold">
            	<i class="fa fa-list tx-yellow mg-r-10 mg-l-10"></i> <?php echo $dados2['nome'];?> 
                <span class="tx-yellow tx-13 mg-l-5">(Página)</span>
            </h4>
			<p class="mg-b-0 pd-l-45 pd-r-45">
            	<?php
