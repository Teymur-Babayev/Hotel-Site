<?php 
	...
	$palavra      = "Fotos do Imóvel"; //modificar somente essa linha
	$tabela       = "tb_imoveis_fotos"; //modificar somente essa linha
	$tabela2      = "tb_imoveis_anuncios"; //modificar somente essa linha
	$file         = "imoveis_fotos";
...
?>
	...
	<div class="br-mainpanel" id="cadastra">
        ...
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30 mg-b-20-force">
            <?php
				if(!empty($dados2['nome'])){
			?>
            <h4 class="tx-gray-800 mg-b-0 tx-20 tx-bold">
            	<i class="fa fa-list tx-yellow mg-r-10 mg-l-10"></i> <span class="tx-yellow">Referência: <?php echo $dados2['referencia'];?> - </span> <?php echo $dados2['nome'];?> 
			...
			?>
            <h4 class="tx-gray-800 mg-b-0 tx-20 tx-bold">
            	<i class="fa fa-list tx-yellow mg-r-10 mg-l-10"></i> Selecione o Imóvel para editar
                <span class="tx-yellow tx-13 mg-l-5">(Fotos do Registro)</span>
            </h4>
            <?php
				}
    ...
    <div class="br-mainpanel">
		...
		<div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30 mg-b-20-force">
            <h4 class="tx-gray-800 mg-b-0 tx-20 tx-bold">
            	<i class="fa fa-list tx-yellow mg-r-10 mg-l-10"></i> <span class="tx-yellow">Referência: <?php echo $dados2['referencia'];?> - </span> <?php echo $dados2['nome'];?> 
                <span class="tx-yellow tx-13 mg-l-5">(Imóvel)</span>
            </h4>
			<p class="mg-b-0 pd-l-45 pd-r-45">
            	<?php
                            ...
                            <div class="row">
                                <div id="listagemItens" align="center">
                                    <ul class="row ui-sortable" align="center">
										...
										<?php 
											$sql = mysqli_query($link, "SELECT * FROM ".$tabela." WHERE id_registro='".$id_tabela_foto."' ORDER BY id_ordem ASC, id ASC");
											while($dados = mysqli_fetch_array($sql)){
										?>
