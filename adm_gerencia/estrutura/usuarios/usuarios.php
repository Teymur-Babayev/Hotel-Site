<?php
	...
	if($acao == "insertDb"){
		...
		mysqli_query($link, "INSERT INTO ".$tabela."(
				...
				'".addslashes($nome)."',
				'".addslashes($login)."',
				'".base64_encode(addslashes($password))."',
				'".addslashes($email)."',
				'S'
			)"
		);
...
?>
				 	...
				 	<div class="row">
                        ...
                        <div class="col-md-12 col-xs-12 mg-b-30">
							<h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-5">
                            	<i class="fa fa-user"></i> Nome do Usuário <span class="tx-danger">*</span>
                            </h6>
                        ...
                        <div class="col-md-6 col-xs-12 mg-b-30">
							<h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-5">
                            	<i class="fa fa-sign-in"></i> Login <span class="tx-danger">*</span>
                            </h6>
							<input type="text" id="login" name="login" value="<?php echo $dados['login']?>" class="form-control" required>
						</div>
                        
                        <div class="col-md-6 col-xs-12 mg-b-30">
							<h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-5">
                            	<i class="fa fa-unlock-alt"></i> Senha <span class="tx-danger">*</span>
                            </h6>
							<input type="text" id="password" name="password" value="<?php echo base64_decode($dados['password']);?>" class="form-control" required>
						</div>
	...
	<?php
		$form2 = "FORMLISTA";
		$busca = "SELECT * FROM ".$tabela." WHERE id!='1' ORDER BY id DESC";			
		$total_reg = "30";
		if(!$page){
			$page = "1";
		}
					...
					<div class="row">
						...
						<div class="col-md-12 col-xs-12">
							<div class="row">
                                ...
                                <div class="col-md-3 col-xs-12">
									<h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-5 tx-center mg-b-15">EMAIL</h6>
								</div>
                                <div class="col-md-3 col-xs-12">
									<h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-5 tx-center mg-b-15">LOGIN</h6>
								</div>
							...
							<ul class="ui-sortable">
								...
								<li id="widgetArray_<?php echo $dados['id'];?>" class="ui-sortable-handle">
									<div class="col-md-12" style="background:<?php echo $bgcolor;?>">
										<div class="row">
											<div class="col-md-1 col-xs-12 tx-gray-800 tx-bold tx-14 tx-center pd-15 box-list">
												<?php 
													if($dados['id'] == "2"){
												?>
											...
											<div class="col-md-3 col-xs-12 tx-gray-800 tx-14 tx-center pd-15 box-list mg-t-5">	
											...
											<div class="col-md-3 col-xs-12 tx-gray-800 tx-14 tx-center pd-15 box-list mg-t-5">	
                                                <strong><?php echo $dados['login'];?></strong>
											</div>
