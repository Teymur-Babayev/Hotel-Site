<?php
	...
	$palavra       = "Transação";
	$tabela        = "tb_imoveis_transacao";
	$file          = "imoveis_transacao";
	$file_redirect = "imoveis_transacao";
...
?>
				 	...
				 	<div class="row">
                        ...
                        <div class="col-md-12 col-xs-12 mg-b-30">
							<h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-5">
                            	Nome da Transação <span class="tx-danger">*</span>
                            </h6>
	...
	<?php
		$form2 = "FORMLISTA";
		$busca = "SELECT * FROM ".$tabela." ORDER BY id ASC";			
		$total_reg = "30";
		if(!$page){
			$page = "1";
		}
	...
	?>
	<div class="br-mainpanel mg-t-40">
