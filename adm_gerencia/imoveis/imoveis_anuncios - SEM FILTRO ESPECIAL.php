<?php
	...
	if($acao == "updateDb"){
		...
		mysqli_query($link, "UPDATE ".$tabela." SET 
			...
			integracao_df_imoveis = '$integracao_df_imoveis',
...
?>
				...
				<?php echo $pos_acao_mensagem;?>
				 ...
				 <div class="br-section-wrapper mg-t-0-force mg-b-50-force">
				 	<div class="row">
                        ...
                        <div class="col-md-4 col-xs-12 mg-b-20">
                            <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-5">
                            	Valor do Imóvel <span class="tx-warning">opcional</span>
                            </h6>
                            <input type="text" id="preco" name="preco" value="<?php echo number_format($dados['preco'], 2, ',', '.');?>" class="form-control">
                        </div>
	...
	<?php
		...
		$busca = "SELECT * FROM ".$tabela." ".$filtro_busca." ORDER BY id_ordem ASC, id DESC";		
