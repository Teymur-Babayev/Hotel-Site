<?php
	...
	$palavra       = "Banners Rotativos";
	$tabela        = "tb_banners";
	$file          = "banners_rotativos";
	$file_redirect = "banners_rotativos";
	...
	if($acao == "updateDb"){
		...
		mysqli_query($link, "UPDATE ".$tabela." SET 
			...
			link_banner = '".addslashes($link_banner)."',
			foto = '$foto_1',
				 	...
				 	<div class="row">
                        ...
                        <div class="col-md-12 col-xs-12 mg-b-30">
							<h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-5">
                            	Nome do Banner <span class="tx-danger">*</span>
                            </h6>
                        ...
                        <div class="col-md-12 col-xs-12 mg-b-30">
							<h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-5">
                            	Link do Banner <span class="tx-warning">opcional</span>
                            </h6>
							<input type="text" id="link_banner" name="link_banner" value="<?php echo $dados['link_banner']?>" class="form-control">
                            <div class="alert alert-warning tx-11">
                                <strong class="d-block d-sm-inline-block-force"><i class="fa fa-warning"></i></strong> 
                                Link para onde quer redirecionar o banner
                            </div>
						</div>
                       
                        <div class="col-md-9 col-xs-12 mg-b-30">
							<h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">
                            	<i class="fa fa-picture-o mg-r-2"></i> BANNER <span class="tx-warning">(1920x850)</span>
                            </h6> 
							<div class="row">
								<div class="col-md-2">
									<?php 
									...
									<div class="col-md-12" style="background:<?php echo $bgcolor;?>">
										<div class="row">
											...
											<div class="col-md-7 col-xs-12 tx-gray-800 tx-14 tx-center pd-15 box-list mg-t-10">	
                                                ...
                                                <br>
                                                <a href="<?php echo $dados['link_banner'];?>" target="_blank">
                                                	<i class="fa fa-link"></i> Abrir link
                                                </a>
                                            </div> 
											<div class="col-md-2 col-xs-12 tx-gray-800 tx-bold tx-14 tx-center pd-15 box-list">
												...
												>
													<img 
														src='<?php echo $_linkCompleto;?>/thumbnail.php?no_img=1&w=125px&h=60px&imagem=assets/uploads/<?php echo $tabela."/".$dados['id']."/".$dados['foto'];?>' 
														border='0' 
														height='60'
													>
												</a>
