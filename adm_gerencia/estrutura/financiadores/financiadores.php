<?php
	...
	$palavra       = "Financiadores";
	$tabela        = "tb_financiadores";
	$file          = "financiadores";
	$file_redirect = "financiadores";
	...
	if($acao == "updateDb"){
		...
		mysqli_query($link, "UPDATE ".$tabela." SET 
			...
			link_financiamento = '".addslashes($link_financiamento)."',
			foto = '$foto_1',
				 	...
				 	<div class="row">
                        ...
                        <div class="col-md-12 col-xs-12 mg-b-30">
							<h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-5">
                            	Nome do Financiador <span class="tx-danger">*</span>
                            </h6>
                        ...
                        <div class="col-md-12 col-xs-12 mg-b-30">
							<h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-5">
                            	Link para Simulação <span class="tx-danger">*</span>
                            </h6>
							<input type="text" id="link_financiamento" name="link_financiamento" value="<?php echo $dados['link_financiamento']?>" class="form-control" required>
                            <div class="alert alert-warning tx-11">
                                <strong class="d-block d-sm-inline-block-force"><i class="fa fa-warning"></i></strong> 
                                Link para a simulação no site do Financiador
                            </div>
						</div>
                       
                        <div class="col-md-9 col-xs-12 mg-b-30">
							<h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">
                            	<i class="fa fa-picture-o mg-r-2"></i> LOGO <span class="tx-warning">(500x300)</span>
                            </h6> 
							<div class="row">
								<div class="col-md-2">
									<?php 
									...
									<div class="col-md-12" style="background:<?php echo $bgcolor;?>">
										<div class="row">
											...
											<div class="col-md-2 col-xs-12 tx-gray-800 tx-bold tx-14 tx-center pd-15 box-list">
												...
												>
													<img 
														src='<?php echo $_linkCompleto;?>/thumbnail.php?no_img=1&w=85px&h=60px&imagem=assets/uploads/<?php echo $tabela."/".$dados['id']."/".$dados['foto'];?>' 
														border='0' 
														height='60'
													>
												</a>
